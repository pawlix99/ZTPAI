...
class ChosenRooms extends Component {
    constructor(props) {
        super(props);
        this.state = {
            rooms: [],
    ...
    componentDidMount() {
        axios.post('http://localhost:8000/accommodation/'+ this.props.match.params.id + '/rooms/free/' + this.props.match.params.begin + '/' + this.props.match.params.end)
            .then(res => {
                ...
                <div className="container">
                    ...
                    <div className={"rooms"}>
                        {this.state.rooms.map(room =>
                            <NavLink to={`/room/${room.idRoom}/${this.props.match.params.begin}/${this.props.match.params.end}`}>
